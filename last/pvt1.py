...
class OverlapPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=7, stride=4, in_chans=64, embed_dim=768):
        super().__init__()
...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=64, num_classes=1000, embed_dims=[48, 96, 192, 384],
